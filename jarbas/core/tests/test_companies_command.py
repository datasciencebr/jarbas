...
class TestCreate(TestCommand):
    ...
    def test_save_companies(self, create, print_count, save_activities):
        ...
        create.assert_called_with(additional_address_details=b'', address=b'', city=b'', cnpj=b'',
                                  email='test@test.com.br', last_updated=b'', latitude=-15.7910966, legal_entity=b'',
                                  longitude=-47.9508743, name='Test', neighborhood=b'', number=1, opening=None,
