...
SECURE_PROXY_SSL_HEADER_PROTO = config('SECURE_PROXY_SSL_HEADER_PROTO', default=False)
if SECURE_PROXY_SSL_HEADER_PROTO:
    SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', SECURE_PROXY_SSL_HEADER_PROTO)
