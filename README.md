...
* `SECURE_PROXY_SSL_HEADER_PROTO` _(str)_ Protocol for [Django `HTTP_X_FORWARDED_PROTO` secure proxy SSL header](https://docs.djangoproject.com/en/1.10/ref/settings/#secure-proxy-ssl-header) (e.g `https`)
